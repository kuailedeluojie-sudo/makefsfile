...
//
//*****************************************************************************
bool NoIncludeFileName = true;
bool g_bExcludeHeaders = true;
...
ShowHelp(void)
{
    ...
    printf("-h        - include files name.  By default, Exclude.\n");
...
ParseCommandLine(int argc, char *argv[])
{
    ...
    while(1)
    {
        ...
        //
        iRetcode = getopt(argc, argv, "i:o:x:hv?qrbfn");
